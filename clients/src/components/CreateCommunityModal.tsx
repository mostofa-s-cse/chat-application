  ...
  return (
    <div className="w-full max-w-md rounded-3xl bg-white">
      <header className="flex items-center justify-between px-4 py-3 border-b border-gray-200 rounded-t-3xl">
        ...
        <h1 className="font-extrabold text-lg">Create Community</h1>
        <button
      ...
      <form className="p-6 flex flex-col gap-4">
        <label className="font-semibold text-base text-gray-700">Community Name</label>
        <input className="border rounded-lg px-3 py-2" type="text" placeholder="Enter community name" />
        <div className="mt-4">
