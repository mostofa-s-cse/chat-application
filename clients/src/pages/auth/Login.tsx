         ...
         <div className="bg-white mx-auto rounded-2xl shadow-lg max-w-md w-full p-4 sm:p-6 md:p-8 lg:p-10 overflow-y-auto">
            ...
            <form className="space-y-6" onSubmit={handleSubmit} noValidate>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full flex items-center justify-center bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white font-semibold py-3 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-blue-600 transition"
              >
